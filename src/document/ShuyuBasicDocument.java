 ...
 */
public class ShuyuBasicDocument extends Document 
{
	/** Create a new BasicDocument object
	 * 
	 * @param text The full text of the Document.
	 */
	public ShuyuBasicDocument(String text)
	{
		super(text);
	}
	...
	public int getNumSentences() {
		int numSentences;
		List<String> punctList = new ArrayList<String>();
		punctList = getTokens("[.!?]+");
		int numSetOfChar = 0;
		if (getTokens("([A-Za-z]+)\\z").size() == 1) {
			numSetOfChar = 1;
		}
		numSentences = punctList.size() + numSetOfChar;
        return numSentences;
	}
